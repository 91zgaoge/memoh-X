...
const file_internal_workspace_bridgepb_bridge_proto_rawDesc = "" +
	...
	"\bmod_time\x18\x05 \x01(\tR\amodTime\"@\n" +
	"\x0fListDirResponse\x12-\n" +
	"\aentries\x18\x01 \x03(\v2\x13.bridgepb.FileEntryR\aentries\"\xde\x01\n" +
	"\tExecInput\x12\x18\n" +
	...
	"\n" +
	"DeleteFile\x12\x1b.bridgepb.DeleteFileRequest\x1a\x1c.bridgepb.DeleteFileResponseB=Z;github.com/Kxiandaoyan/Memoh-v2/internal/workspace/bridgepbb\x06proto3"
