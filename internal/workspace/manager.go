...
import (
	...
	"github.com/Kxiandaoyan/Memoh-v2/internal/workspace/bridge"
)
...
func NewManager(log *slog.Logger, service ctr.WorkspaceService, cfg config.WorkspaceConfig, namespace string, conn *pgxpool.Pool) *Manager {
	if namespace == "" {
